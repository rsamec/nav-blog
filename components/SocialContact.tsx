const SocialContact = () => {
  return (<div className="self-end flex gap-2">
    <a target="_blank" href="https://www.facebook.com/lodenarece/" title="" aria-label="">
    ...
    <a target="_blank" href="https://www.youtube.com/channel/UCvA90HS3EUgEvKe37kA8BBQ?view_as=subscriber" title="" aria-label="">
